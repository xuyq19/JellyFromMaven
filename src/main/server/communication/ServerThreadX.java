    ...
    public static void login() throws IOException {
        ...
        try {
            ...
            if ("Register".equals(message)) {
                inputStream = socket.getInputStream();
                /*
                  从message提取用户信息，用空格隔开
                 */
                String[] userInfo = message.split(" ");
                String bankAccountName = userInfo[0];
                String bankAccountPassword = userInfo[1];
                String bankAccountRealId = userInfo[2];
